...
#include "rs232PortTable/rs232PortTable.h"
#include "rs232AsyncPortTable/rs232AsyncPortTable.h"
#include "rs232Number/rs232Number.h"
...
static void usage(void) {
   printf("usage: rs232PortTable [-D<tokens>] [-f] [-L] [-M] [-H] [LISTENING ADDRESSES]\n"
...
main (int argc, char **argv) {
  ...
  while ((ch = getopt(argc, argv, "D:fHLMx:")) != EOF)
    ...
    case 'H':
      ...
      init_agent("rs232PortTable");        /* register our .conf handlers */
      init_rs232PortTable();  
      init_snmp("rs232PortTable");
  ...
  init_agent("rs232-agent");

  /* init init_rs232Number & rs232PortTable & rs232AsyncPortTable mib code */
  init_rs232Number();
  init_rs232PortTable();
  init_rs232AsyncPortTable();  

  /* read rs232PortTable.conf files. */
  init_snmp("rs232-agent");
