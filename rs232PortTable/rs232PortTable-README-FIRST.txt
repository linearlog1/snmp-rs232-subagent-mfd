...
begin with the rs232PortTable prefix.
...
------------------------------------------------------------------------
  ...
  Editable: Optional
  Usage   : make -f rs232PortTable_Makefile


  File    : rs232PortTable_subagent.c
  ----------------------------------------------------------------------
...
should probably read these next:
   ...
   rs232PortTable-README-rs232PortTable.txt
...
------------------------------------------------------------------------
  ...
  File    : rs232PortTable_interface.c
